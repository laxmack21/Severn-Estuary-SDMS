...
setwd("~/Documents/UoY/Dissertation/Catworm")
locs = read.csv("Catworm_Severn_UTM.csv", header=T, sep = ",")

#loading severn files
#8 Layers - subtidal
tidal_range<-raster("Severn_unaltered Catworm/tidal_range_masked.tif")
min_elev<-raster("Severn_unaltered Catworm/min_elev_masked.tif")
max_velocity<-raster("Severn_unaltered Catworm/max_vel_masked.tif")
max_elev<-raster("Severn_unaltered Catworm/max_elev_masked.tif")
mask_2<-raster("Severn_unaltered Catworm/mask2.tif")
depth<-raster("Severn_unaltered Catworm/bathy_masked.tif")
dry_always<-raster("Severn_unaltered Catworm/always_dry_masked.tif")
intertidal<-raster("Severn_unaltered Catworm/intertidal_masked.tif")
avg_velocity<-raster("Severn_unaltered Catworm/av_vel_masked.tif")
mask<-depth
...
env_uk<-stack(depth,max_elev,max_velocity,min_elev,avg_velocity,dry_always,intertidal,tidal_range)
...
writeRaster(pred_PredFull, filename="pred2_me.tif", options="INTERLEAVE=BAND", overwrite=TRUE)
...
env_Barrage<-stack(tidal_range_Barrage,depth_Barrage,max_fs_Barrage,max_vel_Barrage,mean_vel_Barrage,min_fs_Barrage,intertidal_Barrage,always_dry_Barrage)
...
depth_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/bathy_masked.tif")
max_fs_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/max_elev_masked.tif")
max_vel_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/max_vel_masked.tif")
min_fs_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/min_elev_masked.tif")
mean_vel_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/av_vel_masked.tif")
tidal_range_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/tidal_range_masked.tif")
always_dry_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/always_dry_masked.tif")
intertidal_Lagoon<-raster("Future Data Catworm/Cardiff_Lagoon/intertidal_masked.tif")
#Raster stack commence for lagoon scenariooo
env_Lagoon<-stack(depth_Lagoon,max_fs_Lagoon,max_vel_Lagoon,min_fs_Lagoon,mean_vel_Lagoon,tidal_range_Lagoon,intertidal_Lagoon,always_dry_Lagoon)
