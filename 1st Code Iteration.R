...
setwd("~/Documents/UoY/Dissertation/Common Welk")
locs = read.csv("Common_Welk_Severn.csv", header=T, sep = ",")

#loading severn files
#ONLY 8 FILES ARE UPLOADED NOW & ONLY 7 VARIABLES
...
env_uk<-stack(depth,max_elev,max_velocity,min_elev,avg_velocity,subtidal,tidal_range)
...
pred_PredFull3 <- predict(model, env_uk)
...
writeRaster(pred_PredFull3, filename="pred3_me.tif", options="INTERLEAVE=BAND", overwrite=TRUE)
...
depth_Barrage<-raster("Future Data/Barrage/bathy_masked.tif")
max_fs_Barrage<-raster("Future Data/Barrage/max_elev_masked.tif")
max_vel_Barrage<-raster("Future Data/Barrage/max_vel_masked.tif")
min_fs_Barrage<-raster("Future Data/Barrage/min_elev_masked.tif")
mean_vel_Barrage<-raster("Future Data/Barrage/av_vel_masked.tif")
subtidal_Barrage<-raster("Future Data/Barrage/subtidal_masked.tif")
tidal_range_Barrage<-raster("Future Data/Barrage/tidal_range_masked.tif")
#Stack raster layers into one file
env_Barrage<-stack(tidal_range_Barrage,subtidal_Barrage,depth_Barrage,max_fs_Barrage,max_vel_Barrage,mean_vel_Barrage,min_fs_Barrage)
