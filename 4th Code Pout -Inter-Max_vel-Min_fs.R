...
env_uk<-stack(depth,max_elev,avg_velocity,dry_always,subtidal,tidal_range)
...
writeRaster(pred_PredFull, filename="pred4_me.tif", options="INTERLEAVE=BAND", overwrite=TRUE)
