...
env_uk<-stack(depth,max_elev,min_elev,avg_velocity,dry_always,intertidal,subtidal)
...
writeRaster(pred_PredFull, filename="pred3_me Cockle.tif", options="INTERLEAVE=BAND", overwrite=TRUE)
